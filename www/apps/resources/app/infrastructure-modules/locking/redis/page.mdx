        ...
        providers: [
          {
            ...
            options: {
              ...
              // defaultRetryInterval: 20, // milliseconds
              // maximumRetryInterval: 1000, // milliseconds
...
<Table>
  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      A number indicating the initial time (in milliseconds) to wait before retrying to acquire a lock. Used as the base delay for exponential backoff retries.
    ...
    <Table.Row>
      ...
      A number indicating the maximum time (in milliseconds) to wait before retrying to acquire a lock during exponential backoff.
    ...
    <Table.Row>
      ...
      A number indicating the multiplier used for exponential backoff when retrying to acquire a lock. Each retry delay is multiplied by this factor until reaching `maximumRetryInterval`.
